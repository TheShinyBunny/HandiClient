...
import com.handicraft.client.gen.structure.DarkFortressGenerator.Piece;
import com.handicraft.client.gen.structure.DarkFortressGenerator.PieceData;
...
public class DarkFortressGenerator {
    ...
    public static class CorridorBalcony extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(int i = 0; i <= 5; ++i) {
                for(int j = 0; j <= 8; ++j) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), j, -1, i, boundingBox);
                }
            }
    ...
    public static class CorridorStairs extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(int i = 0; i <= 9; ++i) {
                ...
                for(int m = 0; m <= 4; ++m) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), m, -1, i, boundingBox);
                }
            }
    ...
    public static class CorridorLeftTurn extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(int i = 0; i <= 4; ++i) {
                for(int j = 0; j <= 4; ++j) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), i, -1, j, boundingBox);
                }
            }
    ...
    public static class CorridorNetherWartsRoom extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(q = 4; q <= 8; ++q) {
                for(r = 0; r <= 2; ++r) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), q, -1, r, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), q, -1, 12 - r, boundingBox);
                }
            }
            ...
            for(q = 0; q <= 2; ++q) {
                for(r = 4; r <= 8; ++r) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), q, -1, r, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), 12 - q, -1, r, boundingBox);
                }
            }
    ...
    public static class CorridorExit extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(m = 4; m <= 8; ++m) {
                for(n = 0; n <= 2; ++n) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), m, -1, n, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), m, -1, 12 - n, boundingBox);
                }
            }
            ...
            for(m = 0; m <= 2; ++m) {
                for(n = 4; n <= 8; ++n) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), m, -1, n, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), 12 - m, -1, n, boundingBox);
                }
            }
    ...
    public static class BridgeCrossing extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(k = 7; k <= 11; ++k) {
                for(l = 0; l <= 2; ++l) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), k, -1, l, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), k, -1, 18 - l, boundingBox);
                }
            }
            ...
            for(k = 0; k <= 2; ++k) {
                for(l = 7; l <= 11; ++l) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), k, -1, l, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), 18 - k, -1, l, boundingBox);
                }
            }
    ...
    public static class Bridge extends DarkFortressGenerator.Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for(int i = 0; i <= 4; ++i) {
                for(int j = 0; j <= 2; ++j) {
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), i, -1, j, boundingBox);
                    this.fillDownwards(structureWorldAccess, ModBlocks.DARKNESS_BRICKS.getDefaultState(), i, -1, 18 - j, boundingBox);
                }
            }
    ...
    abstract static class Piece extends StructurePiece {
        ...
        protected StructurePiece method_14814(DarkFortressGenerator.Start start, List<StructurePiece> list, Random random, int i, int j, boolean bl) {
            ...
            if (direction != null) {
                switch(direction) {
                    case NORTH:
                        return this.method_14813(start, list, random, this.boundingBox.minX + i, this.boundingBox.minY + j, this.boundingBox.minZ - 1, direction, this.getChainLength(), bl);
                    case SOUTH:
                        return this.method_14813(start, list, random, this.boundingBox.minX + i, this.boundingBox.minY + j, this.boundingBox.maxZ + 1, direction, this.getChainLength(), bl);
                    case WEST:
                        return this.method_14813(start, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + j, this.boundingBox.minZ + i, direction, this.getChainLength(), bl);
                    case EAST:
                        return this.method_14813(start, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + j, this.boundingBox.minZ + i, direction, this.getChainLength(), bl);
                }
            }
        ...
        protected StructurePiece method_14812(DarkFortressGenerator.Start start, List<StructurePiece> list, Random random, int i, int j, boolean bl) {
            ...
            if (direction != null) {
                switch(direction) {
                    case NORTH:
                    case SOUTH:
                        return this.method_14813(start, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + i, this.boundingBox.minZ + j, Direction.WEST, this.getChainLength(), bl);
                    case WEST:
                    case EAST:
                        return this.method_14813(start, list, random, this.boundingBox.minX + j, this.boundingBox.minY + i, this.boundingBox.minZ - 1, Direction.NORTH, this.getChainLength(), bl);
                }
            }
        ...
        protected StructurePiece method_14808(DarkFortressGenerator.Start start, List<StructurePiece> list, Random random, int i, int j, boolean bl) {
            ...
            if (direction != null) {
                switch(direction) {
                    case NORTH:
                    case SOUTH:
                        return this.method_14813(start, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + i, this.boundingBox.minZ + j, Direction.EAST, this.getChainLength(), bl);
                    case WEST:
                    case EAST:
                        return this.method_14813(start, list, random, this.boundingBox.minX + j, this.boundingBox.minY + i, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getChainLength(), bl);
                }
            }
