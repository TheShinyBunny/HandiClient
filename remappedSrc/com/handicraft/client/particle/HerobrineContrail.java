...
public class HerobrineContrail extends AnimatedParticle {

    public HerobrineContrail(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            try {
                return new HerobrineContrail(world,x,y,z,velocityX,velocityY,velocityZ,provider);
            } catch (Exception e) {
                return null;
            }
