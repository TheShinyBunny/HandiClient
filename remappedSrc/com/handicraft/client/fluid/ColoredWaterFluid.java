...
import com.handicraft.client.mixin.FlowableFluidAccessor;
...
public abstract class ColoredWaterFluid extends FlowableFluid {
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModBlocks.COLORED_WATER_BLOCK_MAP.get(color).getDefaultState().with(FluidBlock.LEVEL,method_15741(state));
    }
