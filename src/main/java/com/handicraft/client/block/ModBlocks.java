...
public class ModBlocks {
    ...
    public static final CakeBlock HALLOWEEN_CAKE = new HalloweenCakeBlock(FabricBlockSettings.of(Material.CAKE,MapColor.ORANGE).strength(0.5F).sounds(BlockSoundGroup.WOOL));
    ...
    public static final Block DARK_STONE = new Block(FabricBlockSettings.of(Material.STONE,MapColor.STONE_GRAY).breakByTool(FabricToolTags.PICKAXES).strength(1.5f,6f));
    ...
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block DARK_LEAVES = new Block(FabricBlockSettings.of(Material.STONE,MapColor.MAGENTA).strength(3f,4f).breakByTool(FabricToolTags.PICKAXES));

    @Register("shadow_stone")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block SHADOW_STONE = new Block(FabricBlockSettings.of(Material.STONE,MapColor.GRAY).breakByTool(FabricToolTags.PICKAXES).strength(1.5f,6f));
    ...
    @Register("dark_log")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block DARK_LOG = new PillarBlock(FabricBlockSettings.of(Material.WOOD,state->state.get(PillarBlock.AXIS) == Direction.Axis.Y ? MapColor.GRAY : MapColor.BLACK).strength(2.0f).sounds(BlockSoundGroup.WOOD));

    @Register("stripped_dark_log")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block STRIPPED_DARK_LOG = new PillarBlock(FabricBlockSettings.of(Material.WOOD,state->state.get(PillarBlock.AXIS) == Direction.Axis.Y ? MapColor.GRAY : MapColor.BLACK).strength(2.0f).sounds(BlockSoundGroup.WOOD));

    @Register("dark_wood")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block DARK_WOOD = new PillarBlock(FabricBlockSettings.of(Material.WOOD,MapColor.BLACK).strength(2.0f).sounds(BlockSoundGroup.WOOD));

    @Register("stripped_dark_wood")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block STRIPPED_DARK_WOOD = new PillarBlock(FabricBlockSettings.of(Material.WOOD,MapColor.GRAY).strength(2.0f).sounds(BlockSoundGroup.WOOD));

    @Register("dark_planks")
    @BlockItem(CreativeTab.BLOCKS)
    public static final Block DARK_PLANKS = new Block(AbstractBlock.Settings.of(Material.WOOD, MapColor.BLACK).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD));
    ...
    public static final DarkFireBlock GREEN_DARK_FIRE = new DarkFireBlock(FabricBlockSettings.of(Material.FIRE,MapColor.GREEN).noCollision().breakInstantly().luminance(s->13),()-> Tags.GREEN_FLAMMABLES);

    @Register("purple_dark_fire")
    public static final DarkFireBlock PURPLE_DARK_FIRE = new DarkFireBlock(FabricBlockSettings.of(Material.FIRE,MapColor.PURPLE).noCollision().breakInstantly().luminance(s->13),()-> Tags.PURPLE_FLAMMABLES);
    ...
    @Register("dirt_slab")
    @BlockItem(CreativeTab.BLOCKS)
    public static final SlabBlock DIRT_SLAB = new SlabBlock(FabricBlockSettings.of(Material.SOIL,MapColor.DIRT_BROWN).strength(0.5f).breakByTool(FabricToolTags.SHOVELS).sounds(BlockSoundGroup.GRAVEL));
