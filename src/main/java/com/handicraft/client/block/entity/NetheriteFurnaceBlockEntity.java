...
public class NetheriteFurnaceBlockEntity extends LockableContainerBlockEntity implements SidedInventory, Tickable {
    ...
    public NetheriteFurnaceBlockEntity() {
        super(CommonMod.NETHERITE_FURNACE_BLOCK_ENTITY_TYPE);
    ...
    public void fromTag(BlockState state, CompoundTag tag) {
        ...
        ListTag ms = tag.getList("Modules", NbtType.COMPOUND);
        int i = 0;
        for (FurnaceModule m : modules) {
    ...
    public CompoundTag toTag(CompoundTag tag) {
        ...
        for (FurnaceModule m : modules) {
            list.add(m.toTag(new CompoundTag()));
        }
    ...
    public class FurnaceModule {
        ...
        public void fromTag(CompoundTag tag) {
            ...
            CompoundTag ru = tag.getCompound("RecipesUsed");
