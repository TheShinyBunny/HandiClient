...
public class DamageEntityObjective implements ObjectiveType<Instance> {
    ...
    public Instance generate(Random random, CountModifier modifier) {
        return new Instance(modifier.modify(HandiUtils.randomEnum(random,Entities.class)),modifier.modify(HandiUtils.randomEnum(random,DamageType.class)),kill);
    }
    ...
    public static class Instance implements ObjectiveInstance {
        ...
        public Instance(Entities type, DamageType damageType, boolean kill) {
            this.type = type;
        ...
        public boolean test(PlayerEntity player, EntityType<?> type, DamageSource source) {
            return this.type.test(type) && this.damageType.test(source);
        }
        ...
        public ItemStack getIcon() {
            return new ItemStack(type.icon);
        }
