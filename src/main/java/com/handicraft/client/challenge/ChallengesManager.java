...
/*
        ...
        addChallenge(21,new StripLogObjective.Instance(BlockTags.LOGS::contains,new ItemStack(Items.DIAMOND_AXE),"Strip 300 log blocks"),300,1);
    ...
    public static ChallengesManager get(ServerWorld world) {
        return world.getPersistentStateManager().getOrCreate(nbt->{
            ChallengesManager m = new ChallengesManager();
            m.fromNbt(nbt);
            return m;
        },ChallengesManager::new,"challenges");
    }
