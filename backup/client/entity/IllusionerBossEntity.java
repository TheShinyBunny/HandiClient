...
public class IllusionerBossEntity extends IllusionerEntity {
    ...
    private class SpawnVexGoal extends SpellcastingIllagerEntity.CastSpellGoal {
    ...
    private class TeleportBehindTargetGoal extends Goal {
        ...
        public void start() {
            ...
            if (!world.getBlockCollisions(IllusionerBossEntity.this,new Box(pos,pos.up())).findAny().isPresent()) {
                IllusionerBossEntity.this.refreshPositionAndAngles(pos.toImmutable(),MathHelper.wrapDegrees(IllusionerBossEntity.this.yaw + 180),IllusionerBossEntity.this.pitch);
            }
        }
